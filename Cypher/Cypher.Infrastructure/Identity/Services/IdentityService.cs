using Cypher.Application.DTOs.Identity;
using Cypher.Application.DTOs.Mail;
using Cypher.Application.DTOs.Settings;
using Cypher.Application.Enums;
using Cypher.Application.Exceptions;
using Cypher.Application.Interfaces;
...
namespace Cypher.Infrastructure.Identity.Services
{
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _mailService.SendAsync(new MailRequest() {
                        ...
                        To = user.Email, Body = $"Please confirm your account by <a href='{verificationUri}'>clicking here</a>.", 
