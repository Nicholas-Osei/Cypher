...
using Cypher.Infrastructure.Identity.Services;
using Cypher.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                // Windows
                //c.IncludeXmlComments(string.Format(@"{0}\Cypher.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                // Linux
                c.IncludeXmlComments(string.Format(@"{0}Cypher.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
